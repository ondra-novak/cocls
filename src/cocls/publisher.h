...
public:
    ...
    public:
        ...
        bool advance_suspend(Handle id, awaiter *awt) {
            std::lock_guard _(_mx);
    ...
    protected:
        ...
        struct subreg_t {
            ...
            awaiter *_awt;   //currently registered awaiter
        ...
        std::vector<awaiter *> _wakeup_buffer;
        ...
        bool advance_suspend_lk(Handle h, awaiter *awt) {
            subreg_t &l = _regs[h];
